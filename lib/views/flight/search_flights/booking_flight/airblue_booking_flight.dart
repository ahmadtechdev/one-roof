...
import 'airarabia/select_seat.dart';
...
class _AirBlueBookingFlightState extends State<AirBlueBookingFlight> {
  ...
  Future<void> _loadUserData() async {
    try {
      // Use the existing functionality from BookingFlightController
      await bookingController.loadUserDataAndInitialize();
